...
| Phát hiện, thử nghiệm điểm yếu, lỗ hổng kỹ thuật của HTTT không đúng quy định về an toàn, an ninh mạng (bộ khung cho rằng có thể áp dụng với việc kiểm thử không được phê duyệt) | NĐ 330 Đ16.1.đ | 40–60 triệu |
...
c) {{DON_VI_CHUYEN_TRACH_ANM}} làm đầu mối phối hợp với nhà cung cấp dịch vụ và phối hợp đơn vị vận hành trong kiểm thử xâm nhập (NĐ 331 Đ32.5). {{DON_VI_VAN_HANH}} sẵn sàng phương án khôi phục trong thời gian kiểm thử.
...
| 5 | Kiểm tra lại; tổng hợp vào báo cáo năm | {{DON_VI_CHUYEN_TRACH_ANM}} | Trước 20/12 (NĐ 331 Đ35.4.a; số liệu chốt đến 14/12, Đ35.3) |
...
- **[CẦN ĐỐI CHIẾU]** Việc cấp giấy phép kinh doanh sản phẩm, dịch vụ ANM do Chính phủ quy định (Luật 116 Đ29.3). **NĐ 332/2026/NĐ-CP** được ghi nhận là văn bản về lĩnh vực này nhưng chưa có toàn văn trong bộ nguồn của repo, nên bộ khung không nêu điều kiện, phạm vi giấy phép cụ thể. Trước khi ký hợp đồng, kiểm tra trực tiếp giấy phép của nhà cung cấp và đối chiếu NĐ 332.
